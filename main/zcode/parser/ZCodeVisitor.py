...
class ZCodeVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ZCodeParser#statement_inBLK.
    def visitStatement_inBLK(self, ctx:ZCodeParser.Statement_inBLKContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ZCodeParser#statement_temp.
    def visitStatement_temp(self, ctx:ZCodeParser.Statement_tempContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ZCodeParser#may_ignore_statement.
